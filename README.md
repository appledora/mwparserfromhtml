...
```
cd existing_repo
git remote add origin https://gitlab.wikimedia.org/repos/research/html-dumps.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.wikimedia.org/repos/research/html-dumps/-/settings/integrations)
